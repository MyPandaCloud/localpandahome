...
<head>
  ...
  <script>
    $(document).ready(function(){
      $("#emby").click(function(){
	      window.location.href = "http://<?php echo $emby; ?>:9292";
      });
      ...
      $("#nextcloud").click(function(){
	      window.location.href = "http://<?php echo $nextcloud; ?>:9292";
      });
      $("#ampache").click(function(){
	      window.location.href = "http://<?php echo $ampache; ?>:9292";
      });
      $("#homeassistant").click(function(){
	      window.location.href = "http://<?php echo $hass; ?>:9292";
      });
      $("#zoneminder").click(function(){
	      window.location.href = "http://<?php echo $zoneminder; ?>:9292";
      });
      $("#transmission").click(function(){
	      window.location.href = "http://<?php echo $transmission; ?>:9292";
      });
    });
